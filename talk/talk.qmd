...
- Previous auditory brainstem mapping at 3T used compromised approaches
:::
...
- Prior work in humans shows consistent dorsal striatal responses in auditory category learning tasks using fMRI (Feng et al., 2019; Lim et al., 2019; Yi et al., 2016)
- Little is known about the anatomical pathways that connect the human auditory system to the striatum
- How do *subdivisions* of dorsal striatum contribute to category learning?
:::
...
## Auditory-striatal pathways for learning and categorization

::: {.incremental}

::: {layout="[25,75]"}

![Macaque^[Yeterian & Pandya (1997)]](images/YeterianPandya1997.png){fig-align="center" height="600" .fragment}

![Human^[Sitek et al. (2022 preprint); Sitek et al. (submitted)]](images/Sitek_corticostriatal_endpoints.png){fig-align="center" height="800" .fragment}
...
## Representational similarity analysis (RSA) of auditory categories

:::: {.columns}

::: {.column width="20%"  .fragment}
![](images/Sitek2025_categorization/Sitek_RSA-models.png){height="800" fig-align="center"}
:::
::: {.column width="40%"  .fragment}
![](images/Sitek2025_categorization/Sitek_RSA-ROI-results.png){height="850" fig-align="center"}
:::
::: {.column width="40%" .fragment}
#### Striatum RSA
  - Stronger Tone than Talker representation overall
...
## Finger motor representation in the human brain {.smaller visibility="hidden"}
